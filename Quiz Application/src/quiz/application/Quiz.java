...
public class Quiz extends JFrame implements ActionListener {
    ...
    Quiz(String name){
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("pics/qzz.jpg"));
        JLabel img = new JLabel(i1);
        img.setBounds(0,0,1200,300);
        add(img);
        
        qno = new JLabel();
        qno.setBounds(100,350,50,20);
        ...
        opt1.setBounds(170,420,600,30);
        opt1.setBackground(Color.WHITE);
        opt1.setFont(new Font("Diagonal",Font.PLAIN,20));
        add(opt1);
        
        opt2 = new JRadioButton();
        opt2.setBounds(170,460,600,30);
        opt2.setBackground(Color.WHITE);
        opt2.setFont(new Font("Diagonal",Font.PLAIN,20));
        add(opt2);
        
        opt3 = new JRadioButton();
        opt3.setBounds(170,500,600,30);
        opt3.setBackground(Color.WHITE);
        opt3.setFont(new Font("Diagonal",Font.PLAIN,20));
        add(opt3);
        
        opt4 = new JRadioButton();
        opt4.setBounds(170,540,600,30);
        opt4.setBackground(Color.WHITE);
        opt4.setFont(new Font("Diagonal",Font.PLAIN,20));
        add(opt4);
        ...
        lifeline.setBounds(900,500,200,40);
        ...
        submit.setBounds(900,550,200,40);
